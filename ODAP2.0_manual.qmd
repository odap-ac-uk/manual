...
### Introduction
Human genetics influences susceptibility to disease. This importance has been shown throughout the COVID-19 pandemic and other outbreaks that followed. 

The aim of ODAP is to enable deeper genetic insights to improve outcomes for patients - in outbreaks and beyond. 

ODAP is a long-term data infrastructure providing researchers the space and tools to better understand genetic differences underlying the mechanisms of severe disease. ODAP is a research environment with up-to-date genomic, clinical, and multi-omic data from a number of UK-wide studies. This is combined with access to a range of software, tools, storage drives, and a high-performance compute cluster.

By continuing to develop and expand these capabilities and indeed knowledge, we will be better prepared for future outbreaks.
