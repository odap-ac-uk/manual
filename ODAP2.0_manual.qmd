...
## Introduction
Human genetics influences susceptibility to disease. This has been shown during the COVID-19 pandemic and other outbreaks that followed. The Outbreak Data Analysis Platform (ODAP) is a long-term data infrastructure providing researchers the space and tools to better understand genetic differences underlying the mechanisms of severe disease. 

The aim of ODAP is to drive insights to improve outcomes for patients in outbreaks and beyond through accessibility and usability of genetic data. ODAP is a research environment with up-to-date genomic, clinical, and multiomic data from a number of UK-wide studies. This is combined with access to a range of software, tools, storage drives, and a high-performance compute cluster.

By continuing to develop and expand these capabilities and knowledge, we will be more prepared for future outbreaks. 
