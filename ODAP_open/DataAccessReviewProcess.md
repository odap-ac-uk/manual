...
No detail on the criteria projects will be reviewed under.
No detail or examples of in-scope or out of scope research or
No detail on how it will be determined a proposal has valid research purpose with defined public benefit.
Mentions an independent external review however it is not clear to me who this is
Mentions that UoE applications go to DAGC but does not detail the process.
Reasons for rejection not fit for purpose.
These should include some of the out-of-scope reasons that were discussed beforehand e.g. Research question is focused on
a non-infectious disease area with incidental involvement of infectious disease or a pathogen with no potential public health concern
-->
